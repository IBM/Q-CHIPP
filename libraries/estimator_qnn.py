...
# QNNCircuit has been removed in qiskit-machine-learning 0.9.0
# from qiskit_machine_learning.circuit.library import QNNCircuit
from qiskit_machine_learning.exceptions import QiskitMachineLearningError

from libraries.neural_network import NeuralNetwork
...
class EstimatorQNN(NeuralNetwork):
    ...
    def __init__(
        ...
        *,
        ...
        # QNNCircuit class removed in qiskit-machine-learning 0.9.0
        # Always use explicit input_params and weight_params
    ...
    def _forward_postprocess(self, num_samples: int, result) -> np.ndarray:
    ...
    def _forward(
        ...
        # )
        # This is for estimator V2
        num_samples = input_data.shape[0]
        weights = np.broadcast_to(weights, (num_samples, len(weights)))
        params = np.concatenate((input_data, weights), axis=1)        
        pubs = ( self._circuit, list(self._observables), params)
        ...
        return self._forward_postprocess(num_samples, results.data.evs)
